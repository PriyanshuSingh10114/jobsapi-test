...
const SemanticMappingRegistry = {
    ...
    // Location
    'COUNTRY': ['location.country', 'contact.country', 'address.country', 'demographics.countryOfOrigin'],
    'STATE': ['location.state', 'contact.state', 'address.state'],
    'CITY': ['location.city', 'contact.city', 'address.city'],
    'ZIP': ['location.zipCode', 'contact.zipCode', 'address.zipCode'],
    ...
    // Work Auth
    'WORK_AUTHORIZATION': ['workAuthorization.status', 'workAuthorization.authorized'],
    'CITIZENSHIP': ['workAuthorization.country', 'workAuthorization.citizenship'],
    ...
    // Preferences
    'EXPECTED_SALARY': ['preferences.salaryExpectations'],
